# Generate update form: Functional document

| app      | feature id | feature type | feature name         | business unit | process   | department |
| :------- | :--------- | :----------- | :------------------- | :------------ | :-------- | :--------- |
| ZERO DEV | feature-04 | web          | Generate update form | division x    | process y | finance    |

---

Clicking in the delete button in the update of entity instances will show a form to update the instance.
